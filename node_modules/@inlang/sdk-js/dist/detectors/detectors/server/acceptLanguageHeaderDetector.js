...
const acceptLanguageHeaderDetector = ((headers) => headers.get("Accept-Language")
 ...
 */
export const initAcceptLanguageHeaderDetector = ((headers) => () => acceptLanguageHeaderDetector(headers));
